...
impl InstanceController {
    pub fn new(instances: Vec<Instance>, device: &wgpu::Device) -> InstanceController {
        InstanceController {
...
// Just random constants for instance testing. Should not be part of the end product
